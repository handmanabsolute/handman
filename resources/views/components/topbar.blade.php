<header class="sticky top-0 z-30 h-16 bg-blue-600 border-b border-blue-700/50 flex items-center justify-between px-4 sm:px-6 shadow-sm">
    ...
    <div class="flex items-center space-x-2 sm:space-x-4 justify-end md:w-1/4">
        ...
        <div class="relative">
            <button id="user-menu-btn" class="flex items-center space-x-2 bg-white/10 border border-white/10 focus:outline-none rounded-full py-1.5 pl-4 pr-1.5 hover:bg-white/15 transition-colors group cursor-pointer">
                ...
                <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->email) }}&background=ffffff&color=2563EB" alt="Avatar" class="w-8 h-8 rounded-full object-cover shadow-xs">
            </button>
